...
2. Follow the best practices listed below
    a. Dictionary Returns: Tools return {"status": "success", 
    "data": ...} or {"status": "error", "error_message": ...}
    b. Clear Docstrings: LLMs use docstrings to understand when 
    and how to use tools
    c. Type Hints: Enable ADK to generate proper schemas 
    (str, dict, etc.)
    e. Error Handling: Structured error responses help LLMs 
    handle failures gracefully
3. Add your function to the agent's tools=[] list and 
